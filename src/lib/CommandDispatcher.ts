...
export default class CommandDispatcher<S> {
    ...
    public parse(command: string | StringReader, source: S): ParseResults<S> {
        ...
        let context: CommandContextBuilder<S> = new CommandContextBuilder(
            this,
            source,
            this.root,
            command.getCursor()
    ...
    private addPaths(
        node: CommandNode<S>,
        result: Array<Array<CommandNode<S>>>,
        parents: Array<CommandNode<S>>
    ): void {
